      ...
      <div class="card">
        <div class="row">
          <div class="col-md-4 pe-md-0">
            <div class="auth-side-wrapper" style="background-image: url({{asset('assets/images/login.jpeg')}})">
            </div>
          </div>
          <div class="col-md-8 ps-md-0">
            <div class="auth-form-wrapper px-4 py-5">
              <a href="#" class="noble-ui-logo d-block mb-2">DB<span>Jobs</span></a>
              ...
              <form method="POST" action="{{ route('login') }}">
                ...
                <a href="{{ route('daftar_pekerja') }}" class="d-block mt-3 text-muted">Not a user? Sign up</a>
              </form>
            </div>
          </div>
        </div>
